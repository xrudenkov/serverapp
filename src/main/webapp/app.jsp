...
<body>
    ...
    <caption>Пользователи</caption>
      ...
      <% ResultSet resultSet = (ResultSet) request.getAttribute("resultSet");
           while (resultSet.next()){
            ...
            <tr>
                  <td> <%= id %> </td>
                  <td onclick="handle(this)" id="<%= id %>" number="1" name="name"><%= name %> </td>
    ...
    <form id="form" action=app method="post" accept-charset="utf-8">
          ...
          <input type="text" id="nik" name="nik" value="1">
    ...
    function handle(object){
         ...
         inp.onkeydown = function(e){
             if(e.keyCode === 13){
                   ...
                   document.getElementById("nik").value = inp.name;
                   document.getElementById("value").value = object.innerText;
